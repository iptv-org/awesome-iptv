...
- [Vidqo.com](https://vidqo.com/) - Open-source and Nex-Gen IPTV player application, the ultimate web-based media player designed for seamless streaming, enhanced performance, and rich premier features. Built with modern web technologies to deliver a fast, intuitive & fully customizable experience for users and developers alike
